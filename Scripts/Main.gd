...
func _ready() -> void:
	...
	$Start.visible = true
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 15, OS.get_ticks_usec(), '')


func _process(_delta: float) -> void:
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 18, OS.get_ticks_usec(), '')
	if !_rc_mode:
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 19, OS.get_ticks_usec(), '')
		return
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 20, OS.get_ticks_usec(), '')
	if Input.is_action_just_pressed("emergency"):
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 21, OS.get_ticks_usec(), '')
		_tello.emergency()
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 22, OS.get_ticks_usec(), '')
		_rc_mode = false
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 23, OS.get_ticks_usec(), '')
		_rc_mode_started = false
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 24, OS.get_ticks_usec(), '')
		$DebugStuff/Box/Box/RC.pressed = false
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 25, OS.get_ticks_usec(), '')
		return
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 26, OS.get_ticks_usec(), '')
	if Input.is_action_just_pressed("takeoff"):
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 27, OS.get_ticks_usec(), '')
		_tello.takeoff()
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 28, OS.get_ticks_usec(), '')
		_rc_mode_started = true
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 29, OS.get_ticks_usec(), '')
		return
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 30, OS.get_ticks_usec(), '')
	if Input.is_action_just_pressed("land"):
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 31, OS.get_ticks_usec(), '')
		_tello.land()
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 32, OS.get_ticks_usec(), '')
		_rc_mode = false
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 33, OS.get_ticks_usec(), '')
		_rc_mode_started = false
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 34, OS.get_ticks_usec(), '')
		$DebugStuff/Box/Box/RC.pressed = false
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 35, OS.get_ticks_usec(), '')
		return
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 36, OS.get_ticks_usec(), '')
	_handle_rc_control()
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 37, OS.get_ticks_usec(), '')


func _handle_rc_control() -> void:
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 40, OS.get_ticks_usec(), '')
	if !_rc_mode_started:
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 41, OS.get_ticks_usec(), '')
		return
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 42, OS.get_ticks_usec(), '')
	var forward_backward := _input_forward_back()
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 43, OS.get_ticks_usec(), '')
	var left_right := _input_left_right()
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 44, OS.get_ticks_usec(), '')
	var yaw := _input_turn_left_right()
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 45, OS.get_ticks_usec(), '')
	var up_down := _input_up_down()
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 46, OS.get_ticks_usec(), '')
	_tello.rc(left_right * _speed, forward_backward * _speed, up_down * _speed, yaw * _speed)
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 47, OS.get_ticks_usec(), '')


func _input_up_down() -> int:
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 50, OS.get_ticks_usec(), '')
	var up_down := 0
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 51, OS.get_ticks_usec(), '')
	if Input.is_action_pressed("up"):
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 52, OS.get_ticks_usec(), '')
		up_down += 1
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 53, OS.get_ticks_usec(), '')
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 53, OS.get_ticks_usec(), '')
	if Input.is_action_pressed("down"):
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 54, OS.get_ticks_usec(), '')
		up_down += -1
...
func _input_turn_left_right() -> int:
	...
	var yaw := 0
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 60, OS.get_ticks_usec(), '')
	if Input.is_action_pressed("turn_left"):
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 61, OS.get_ticks_usec(), '')
		yaw += -1
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 62, OS.get_ticks_usec(), '')
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 62, OS.get_ticks_usec(), '')
	if Input.is_action_pressed("turn_right"):
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 63, OS.get_ticks_usec(), '')
		yaw += 1
...
func _input_left_right() -> int:
	...
	var left_right := 0
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 69, OS.get_ticks_usec(), '')
	if Input.is_action_pressed("left"):
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 70, OS.get_ticks_usec(), '')
		left_right += -1
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 71, OS.get_ticks_usec(), '')
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 71, OS.get_ticks_usec(), '')
	if Input.is_action_pressed("right"):
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 72, OS.get_ticks_usec(), '')
		left_right += 1
...
func _input_forward_back() -> int:
	...
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 78, OS.get_ticks_usec(), '')
	if Input.is_action_pressed("forward"):
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 79, OS.get_ticks_usec(), '')
		forward_backward += 1
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 80, OS.get_ticks_usec(), '')
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 80, OS.get_ticks_usec(), '')
	if Input.is_action_pressed("back"):
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 81, OS.get_ticks_usec(), '')
		forward_backward += -1
...
func update_rc_mode(val: bool) -> void:
	...
	_rc_mode = val
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 87, OS.get_ticks_usec(), '')
...
func _on_Send_pressed() -> void:
	...
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 91, OS.get_ticks_usec(), '')
	if cmd.length() == 0:
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 92, OS.get_ticks_usec(), '')
		return
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 93, OS.get_ticks_usec(), '')
	_tello.send_cmd(cmd)
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 94, OS.get_ticks_usec(), '')
...
func _on_Tello_recived_control_code(val) -> void:
	...
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 98, OS.get_ticks_usec(), '')
...
func _on_Tello_command_send(cmd) -> void:
	...
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 102, OS.get_ticks_usec(), '')


func _on_CheckBox_toggled(button_pressed: bool) -> void:
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 105, OS.get_ticks_usec(), '')
	if button_pressed:
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 106, OS.get_ticks_usec(), '')
		($DebugStuff as MarginContainer).rect_position.x = 5
		NaiveGDScriptProfiler.note('Scripts/Main.gd', 107, OS.get_ticks_usec(), '')
	else:
...
func _on_ForwardLeft_pressed() -> void:
	...
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 168, OS.get_ticks_usec(), '')


func _on_ForwardRight_pressed() -> void:
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 171, OS.get_ticks_usec(), '')
	_tello.go(_distance, -_distance, 0, _speed)
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 172, OS.get_ticks_usec(), '')


func _on_BackwardLeft_pressed() -> void:
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 175, OS.get_ticks_usec(), '')
	_tello.go(-_distance, _distance, 0, _speed)
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 176, OS.get_ticks_usec(), '')


func _on_BackwardRight_pressed() -> void:
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 179, OS.get_ticks_usec(), '')
	_tello.go(-_distance, -_distance, 0, _speed)
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 180, OS.get_ticks_usec(), '')


func _on_EmergencyOff_pressed() -> void:
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 183, OS.get_ticks_usec(), '')
	_tello.emergency()
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 184, OS.get_ticks_usec(), '')
	_rc_mode_started = false
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 185, OS.get_ticks_usec(), '')


func _on_start_pressed() -> void:
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 188, OS.get_ticks_usec(), '')
	$Start/CenterContainer/Welcome.visible = false
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 189, OS.get_ticks_usec(), '')
	$Start/CenterContainer/WaitAnimation.visible = true
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 190, OS.get_ticks_usec(), '')
	$Start/CenterContainer/WaitAnimation.play = true
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 191, OS.get_ticks_usec(), '')
	_tello.start()
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 192, OS.get_ticks_usec(), '')
	yield(_tello, "recived_control_code_ok")
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 193, OS.get_ticks_usec(), '')
	$Start/CenterContainer/WaitAnimation.play = false
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 194, OS.get_ticks_usec(), '')
	$Start.visible = false
	NaiveGDScriptProfiler.note('Scripts/Main.gd', 195, OS.get_ticks_usec(), '')
